...
if option == 'Contexte':
    ...
    st.write(df.head(10))
    st.write("</li><li>Le second jeu de donnes se concentre exclusivement sur l'année 2021 et concerne 149 pays, correspondant à 149 lignes d'enregistrement<br>", unsafe_allow_html=True)
