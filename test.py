...
if option == 'Contexte':
    ...
    st.write("<ul><li>Dans le champ 'Log GDP per capita', un nombre allant de 0 à 11<\li><li>Dans 'Social support', un nombre décimal compris entre 0 et 1<\li><li>Dans 'Healthy life expectancy at birth', un âge entre 0 et 100 ans<\li><li>Dans 'Freedom to make life choices', un nombre décimal compris entre 0 et 1<\li><li>Dans 'Generosity', un nombre décimal compris entre -1 et 1<\li><li>Dans 'Perceptions of corruption', un nombre décimal compris entre 0 et 1<\li><li>Dans 'Positive affect', un nombre décimal compris entre 0 et 1<\li><li>Dans 'Negative affect', un nombre décimal compris entre 0 et 1<\li><\ul>", unsafe_allow_html=True)     
